...
def main(argv):
    ...
    # with open('output/yolof_config/AAA_resnet_dilate50_batch2_dropoutearly0_5_lr0_0025_onecycle_iter160000_2021_09_02_01_11_53/conf.pkl', 'rb') as file:
